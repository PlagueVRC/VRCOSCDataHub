...
{
    public static readonly HashSet<string> _commonParameters = new()
    {
        "VRCFaceBlendV",
        "VRCFaceBlendH",
        "VRCEmote",
    ...
    public static List<WeakReference<OscAvatarConfig>> _avatarConfigs = new();
    public static void RegisterAvaterConfig(OscAvatarConfig avatarConfig)
    {
