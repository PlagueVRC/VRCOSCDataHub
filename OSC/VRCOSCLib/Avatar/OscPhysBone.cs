...
public class OscPhysBone
{
    ...
    public OscPhysBone(OscAvatarParametorContainer parameters, string paramName)
        : this(parameters, paramName, true, nameof(parameters))
    {
    }

    public OscPhysBone(OscAvatarParametorContainer parameters, string paramName, bool needCheck, string checkedParamName = "parameters")
    {
    ...
    public void OnParameterChanged(OscAvatarParameter param, ValueChangedEventArgs e)
    {
