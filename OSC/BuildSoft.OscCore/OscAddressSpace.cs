...
public sealed class OscAddressSpace
{
    ...
    public readonly OscAddressMethods _addressToMethod;
    ...
    public Regex[] _patterns = new Regex[DefaultPatternCapacity];
    public OscActionPair[] _patternMethods = new OscActionPair[DefaultPatternCapacity];
