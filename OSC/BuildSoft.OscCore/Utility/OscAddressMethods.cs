...
public sealed unsafe class OscAddressMethods : IDisposable
{
    ...
    /// </summary>
    public readonly Dictionary<string, BlobString> _sourceToBlob;
    ...
    [Il2CppSetOption(Option.NullChecks, false)]
    public void Add(string address, List<OscActionPair> callbacks)
    {
